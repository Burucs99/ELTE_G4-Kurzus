...
class Materials{
    public:
        ...
        G4Material* GetNatriumIodineMaterial() { return this->natriumIodineMatrial; }
    ...
    private:
        ...
        G4Material *airMaterial, *leadMaterial, *copperMaterial, *concreteMaterial, 
                    *steelMaterial, *aluminiumMaterial, *magnesiumOxidMaterial, *natriumIodineMatrial, *waterMaterial;
