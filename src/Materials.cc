...
void Materials::BuildNatriumIodineMaterial() {
    this->natriumIodineMatrial = new G4Material("NatriumIodine", 3.67 * g/cm3, 2);
    this->natriumIodineMatrial->AddElement(this->elNa, 1);
    this->natriumIodineMatrial->AddElement(this->elI, 1);
}
...
Materials::~Materials() {
    ...
    delete this->natriumIodineMatrial;
